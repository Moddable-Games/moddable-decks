...
- Nukes version: fixed v0.9.2 → v0.9.3 (3 instances)
- Nukes components: fixed 60 tokens → 75, 19 tiles → 44
- Hyper Imperium time: fixed "under 3 hours" → "4–6 hours (vs 8+)"
- URL paths: fixed /tool/ → /tools/ (5 instances)
- WordPress claim: fixed to "static HTML + GitHub Pages"
- Discord count: fixed 200+ → 2,400+
- "Nuke Chess" → "Nukes" (10 instances)
